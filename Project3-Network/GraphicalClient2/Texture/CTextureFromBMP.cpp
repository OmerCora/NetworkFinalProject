...
bool CTextureFromBMP::CreateNewCubeTextureFromBMPFiles(std::string cubeMapName, std::string fileNameFullPath)
{
	...
	if (this->LoadBMP(fileNameFullPath))
	{
		glTexImage2D(GL_TEXTURE_CUBE_MAP,		// target (2D, 3D, etc.)
			0,					// MIP map level 
	...
	GLenum &errorEnum, std::string &errorString, std::string &errorDetails)
{
	...
	{
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X,		// target (2D, 3D, etc.)
			0,					// MIP map level 
			GL_RGBA,			// internal format
			this->m_numberOfColumns,	// width (pixels)
			this->m_numberOfRows,	// height (pixels)
	...
	{
		glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_X,		// target (2D, 3D, etc.)
			0,					// MIP map level 
			GL_RGBA,			// internal format
			this->m_numberOfColumns,	// width (pixels)
			this->m_numberOfRows,	// height (pixels)
	...
	{
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Y,		// target (2D, 3D, etc.)
			0,					// MIP map level 
			GL_RGBA,			// internal format
			this->m_numberOfColumns,	// width (pixels)
			this->m_numberOfRows,	// height (pixels)
	...
	{
		glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y,		// target (2D, 3D, etc.)
			0,					// MIP map level 
			GL_RGBA,			// internal format
			this->m_numberOfColumns,	// width (pixels)
			this->m_numberOfRows,	// height (pixels)
	...
	{
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Z,		// target (2D, 3D, etc.)
			0,					// MIP map level 
			GL_RGBA,			// internal format
			this->m_numberOfColumns,	// width (pixels)
			this->m_numberOfRows,	// height (pixels)
	...
	{
		glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z,		// target (2D, 3D, etc.)
			0,					// MIP map level 
			GL_RGBA,			// internal format
			this->m_numberOfColumns,	// width (pixels)
			this->m_numberOfRows,	// height (pixels)
